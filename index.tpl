		...
		<aside id="VCLnavi">
			<div id="VCLnaviCNT">
				...
				<section id="bannerCNT" class="clearfix">
					<img src="images/banners/vocalendar-banner-regular-s.gif" alt="" />
					<a href="http://bit.ly/vcl90005" target="_blank"><img src="images/banners/vocalendar-banner-gumitan2012.jpg" alt="" style="margin-left: 10px;" /></a>
				</section>
			</div>
		</aside>
